...
<div className="">
                    <h2 className="">Brick Street Privacy Policy</h2>
                    <div className="">
    <p className=''>
        At Brick Street, we understand the importance of protecting your personal information. We are committed to maintaining the privacy and security of your data in accordance with this Privacy Policy. This policy explains the types of information we collect, how we use it, and the steps we take to protect it.
<br />
    <br />
...
By using the Brick Street website or services, you agree to the terms of this Privacy Policy. If you do not agree with these terms, please do not use our website or services.
 </p>
        </div>
    </div> 
