                    ...
                    <div className="col-md-6 col-xl-4">
                        <div className="card mb-5">
                            <div className="card-body d-flex flex-column align-items-center">
                                <div className="bs-icon-xl bs-icon-circle bs-icon my-4"><svg className="bi bi-person" xmlns="http://www.w3.org/2000/svg" width="3em" height="3em" fill="currentColor" viewBox="0 0 16 16">
                                ...
                                <form className="text-center" method="post">
                                    ...
                                    <div className="mb-3"><button className="btn btn-moving-gradient btn-dark d-block w-100" type="submit">Log In</button></div>
