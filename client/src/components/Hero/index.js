    ...
    return (
        <section className="py-4 py-xl-5">
            <div className="container">
                <div className="hero-container-custom-css border rounded border-0 d-flex flex-column justify-content-center align-items-center p-4 py-5">
                    <div className="row">
                        <div className="col-md-10 col-xl-8 text-center d-flex d-sm-flex d-md-flex justify-content-center align-items-center mx-auto justify-content-md-start align-items-md-center justify-content-xl-center">
                            <div>
                                <h1 className="text-uppercase fw-bold mb-3">Rediscover the fun of building with Brick Street</h1>
                                <p className="mb-4">Buy and Sell Legos<br />Connect with Lego Enthusiasts</p>
